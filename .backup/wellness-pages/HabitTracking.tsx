...
export default function HabitTracking() {
  ...
  const { trackInteraction, effectiveness } = useModuleLearning('habittracking');

  const logEntryMutation = trpc.wellness.logHabitTracking.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">HabitTracking</h1>
