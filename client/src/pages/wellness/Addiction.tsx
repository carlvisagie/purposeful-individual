...
export default function Addiction() {
  ...
  const { trackInteraction, effectiveness } = useModuleLearning('addiction');

  const logEntryMutation = trpc.wellness.logAddiction.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Addiction</h1>
