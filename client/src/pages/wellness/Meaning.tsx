...
export default function Meaning() {
  ...
  const { trackInteraction, effectiveness } = useModuleLearning('meaning');

  const logEntryMutation = trpc.wellness.logMeaning.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Meaning</h1>
