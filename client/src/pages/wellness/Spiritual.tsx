...
export default function Spiritual() {
  ...
  const { trackInteraction, effectiveness } = useModuleLearning('spiritual');

  const logEntryMutation = trpc.wellness.logSpiritual.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Spiritual</h1>
