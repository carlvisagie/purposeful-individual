...
export default function ScreenTime() {
  ...
  const { trackInteraction, effectiveness } = useModuleLearning('screentime');

  const logEntryMutation = trpc.wellness.logScreenTime.useMutation({
    onSuccess: () => {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">ScreenTime</h1>
